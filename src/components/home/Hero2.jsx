...
export default function Hero2() {
  return (
    <div className="relative  bg-[url('https://images.pexels.com/photos/3756941/pexels-photo-3756941.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')] w-screen h-screen bg-cover grid place-items-center bg-center">
