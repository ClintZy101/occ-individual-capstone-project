...
export default function HeroCTA({text="Shop Now", Icon}) {
  return (
    <button className='group flex  items-center justify-center font-mono h-[40px] w-[200px] bg-black text-white px-5 hover:scale-105  transition-all duration-500 uppercase cursor-pointer mx-auto'>
